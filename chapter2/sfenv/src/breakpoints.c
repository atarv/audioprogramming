...
/*
 * Normalize breakpoints values from current_max to target_max
 */
void normalize_breakpoints(BREAKPOINT *points, size_t size, double current_max,
                           double target_max)
{
    double factor = target_max / current_max;
    for(size_t i = 0; i < size; i++)
    {
